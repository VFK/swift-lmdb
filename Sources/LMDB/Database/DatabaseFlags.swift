...
public struct DatabaseFlags: OptionSet {
     ...
     */
    public static let reverseKey = DatabaseFlags(rawValue: MDB_REVERSEKEY)
     ...
     */
    public static let dupSort = DatabaseFlags(rawValue: MDB_DUPSORT)
    
    /**
     Keys are binary integers in native byte order, either unsigned int or size_t, and will be sorted as such.
     The keys must all be of the same size.
     */
    public static let integerKey = DatabaseFlags(rawValue: MDB_INTEGERKEY)
     ...
     */
    public static let dupFixed = DatabaseFlags(rawValue: MDB_DUPFIXED)
    
    /**
     This option specifies that duplicate data items are binary integers, similar to MDB_INTEGERKEY keys.
     */
    public static let integerDup = DatabaseFlags(rawValue: MDB_INTEGERDUP)
    
    /**
     This option specifies that duplicate data items should be compared as strings in reverse order.
     */
    public static let reverseDup = DatabaseFlags(rawValue: MDB_REVERSEDUP)
}
