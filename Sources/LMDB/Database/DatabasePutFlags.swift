...
public struct DatabasePutFlags: OptionSet {
     ...
     */
    public static let noDupData = DatabasePutFlags(rawValue: MDB_NODUPDATA)
     ...
     */
    public static let noOverwrite = DatabasePutFlags(rawValue: MDB_NOOVERWRITE)
     ...
     */
    public static let reserve = DatabasePutFlags(rawValue: MDB_RESERVE)
     ...
     */
    public static let append = DatabasePutFlags(rawValue: MDB_APPEND)
    
    /**
     As .append, but for sorted dup data.
     */
    public static let appendDup = DatabasePutFlags(rawValue: MDB_APPENDDUP)
}
